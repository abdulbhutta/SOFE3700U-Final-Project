...
CREATE TABLE `currentlyenrolled` (
  ...
  CONSTRAINT `currentlyenrolled_ibfk_1` FOREIGN KEY (`StudentID`) REFERENCES `students` (`StudentID`),
  CONSTRAINT `currentlyenrolled_ibfk_2` FOREIGN KEY (`CourseCode`) REFERENCES `courses` (`CourseCode`)
...
INSERT INTO `currentlyenrolled` VALUES (100785800,'SOFE3450','40100','2021'),(100703887,'MECE3220','44210','2022'),(100704514,'BUSI1000','40050','2021'),(100745913,'AUTE3010','42250','2021'),(100757350,'MEDI1000','41500','2022'),(100785802,'COMP3070','44500','2021');
