        ...
        <?php include "navbar.php"?>
            ...
            <div class='container'>
                ...
                <table class = 'table table-hover'>
                    ...
                    <?php                                   
                        $sql = "SELECT StudentID as UserID, Fname, Lname, PhoneNumber, Vaccinated FROM STUDENTS WHERE vaccinated = 'Yes' 
                                UNION
                                SELECT ProfessorID as UserID, Fname, Lname, PhoneNumber, Vaccinated FROM Professors WHERE vaccinated = 'Yes'
                                UNION
                                SELECT UserID as UserID, FirstName as Fname, LastName as LName, PhoneNumber, Vaccinated FROM Administrators WHERE vaccinated = 'Yes';"; 
